...
export const SubtitleSettingsWarning = ({ jobStatus }: SubtitleSettingsWarningProps) => {
  ...
  return (
    <Alert className="border-blue-500/20 bg-blue-950/20 mb-6">
      ...
      <AlertDescription className="text-blue-200/70">
        <div className="space-y-2 mt-2">
          <p>
            As preferências de legendas são aplicadas <strong className="text-blue-100">durante a renderização</strong> do vídeo.
          </p>
          <p>
          ...
          <div className="flex items-center gap-2 mt-3 p-2 bg-blue-900/30 rounded">
            <Sparkles className="w-4 h-4 text-blue-400 flex-shrink-0" />
            <span className="text-sm">
              <strong className="text-blue-100">Dica:</strong> Na próxima vez, configure as legendas na página inicial antes de enviar o vídeo!
            </span>
          </div>
        </div>
      </AlertDescription>
