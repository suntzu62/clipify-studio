...
# 2. Verificar Redis
# ======================================
log_info "2. Testando Redis..."

node -e "
const redis = require('redis');
const url = require('fs').readFileSync('.env', 'utf8')
  .split('\\n')
...
const client = redis.createClient({
  url: url,
  socket: { connectTimeout: 3000, reconnectStrategy: () => null }
});
...
" 2>&1 || log_warn "Redis conectividade offline (pode estar OK em dev)"
...
# ======================================
log_info "3. Verificando TypeScript compilation..."
...
# ======================================
# 4. Verificar funções de render
# ======================================
log_info "4. Verificando funções no render.ts..."
...
# 5. Verificar imports
# ======================================
log_info "5. Verificando imports críticos..."
...
# ======================================
# 6. Verificar tratamento de erro
# ======================================
log_info "6. Verificando tratamento de erros..."
